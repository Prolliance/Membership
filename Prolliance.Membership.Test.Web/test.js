define(function (require, exports, module) {
    ...
    self.format = function (html_source, indent_size, indent_character, max_char) {
        ...
        function Parser() {
            ...
            this.get_token = function () { //initial handler for token-retrieval
                ...
                if (this.last_token === 'TK_TAG_SCRIPT') { //check if we need to format javascript
                    ...
                    token = self.format(temp_token, this.indent_size, this.indent_character, this.indent_level); //call the JS Beautifier
